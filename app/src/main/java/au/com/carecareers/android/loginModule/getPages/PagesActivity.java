...
public class PagesActivity extends BaseActivity implements
        PagesContract.ITermsAndConditionsView {
    ...
    protected void injectComponent(BaseComponent baseComponent) {
        baseComponent.provideTermsAndConditionsSubComponent(new PagesModule()).inject(this);
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (pageFlag == AppContract.Page.TERMS_AND_CONDITIONS) {
            ...
            presenter.getPages(type, idOrSlug);
    ...
    @Override
    public void naviagteToTermsAndConditonsWebView(PagesModel.PagesRespones pagesRespones) {
        ...
        wvTermsAndConditions.loadDataWithBaseURL(baseUrl, pagesRespones.getContent(), "text/html", "UTF-8", null);
    }
