...
public class SettingsActivity extends BaseActivity implements SettingContract.ISettingView {
    ...
    void onTermsAndConditionsClicked() {
        PagesActivity.start(this, AppContract.Page.TERMS_AND_CONDITIONS);
        transitionActivityOpen();
    }

    @OnClick(R.id.tv_privacy_policy)
    void onPrivacyPolicyClicked() {
        PagesActivity.start(this, AppContract.Page.PRIVACY_POLICY);
        transitionActivityOpen();
    }
...
//        this.startActivity(sendIntent);
    ...
    public void setupToolbar() {
        ...
        tvToolbarTitle.setText(getString(R.string.tv_menu));
    }
